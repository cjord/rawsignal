...
test("characterizes Sealed defaults and guards the disabled Scalper fallback", async () => {
  ...
  assert.match(sealed, /useState<Game>\(\(\)=>initialState\.market==="scalping"&&!scalperEnabled\?"pokemon":initialState\.market\)/);
