...
export async function detailRecord(kind:CatalogKind,productId:string,market?:string){if(!/^-?\d{1,9}$/.test(productId))return null;return loadCatalogDetail(kind,Number(productId),market,await detailOrigin())}
