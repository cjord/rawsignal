...
export type MarketLeaderboardProps={className:string;id:string;historyStatus?:string;header:ReactNode;beforeControls?:ReactNode;controls:ReactNode;sortSurface:ReactNode;rowsClassName:string;rowsRole?:"rowgroup";state:ResultState;loadingLabel:string;skeletonCount:number;errorMessage:string;emptyMessage:string;onRetry:()=>void;rows:ReactNode;pagination?:PaginationModel;paginationAside?:ReactNode;footer?:ReactNode};
