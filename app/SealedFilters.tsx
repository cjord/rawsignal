...
export default function SealedFilters(props:Props){
 const {sets,selectedSets,onSets,marketMin,marketMax,onMarketMin,onMarketMax,msrpMin,msrpMax,onMsrpMin,onMsrpMax,profitMin,profitMax,onProfitMin,onProfitMax,profitPctMin,profitPctMax,onProfitPctMin,onProfitPctMax,onReset,showProfit=true}=props,root=useDismissibleDetails();
