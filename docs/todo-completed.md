# Completed to-do items — shipped work and resolved decisions
...
**Landed 2026-08-28 (staging-verified; released to production the same evening):** All eight items plus
...
## M. Ingestion scaling — implementation notes for M1–M3 (M4/M5 released 2026-09-01, M6 executed 2026-09-01; see the table in docs/todo.md)
...
## P. Signal-model evolution — P1 through P7 (landed 2026-09-01 → 2026-09-03, all in production)
...
**Status: code LANDED 2026-09-01 (gate green, 195 tests); RELEASED to production
2026-09-01 night with P1/P2/P1b (migrations 0009+0010 applied).** `core/domain/regime.ts` classifies the six regimes
...
(P4/P5 scope). Labels reviewed and released; the P1b shadow has been accruing in
production since the first post-deploy rollup (~2026-09-02).
...
**P7 COMPLETE — released to production 2026-09-03** (Worker version `c00fd0fb`, the
last of four Sep 2–3 releases; migrations through 0012 applied to the production D1;
presale coverage walks TCGCSV groups up to 120 days before street date). Delta Reign's
tracked presale products serve blended EVEs today. **Next scheduled task: the October
2026 model-verification review** (`docs/model-gaps.md` → Review calendar, Month 1): the
first 30-day shadow verdict and v2.2 promotion decision, sales-floor sanity check, and
EVE-vs-actual monitoring for the presale products already being served.
